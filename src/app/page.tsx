...
export default function HomePage() {
  ...
  <button>Send</button>
      ...
      <footer className="relative border-t border-white/10 px-5 py-10 text-center text-sm text-slate-400 sm:px-8 space-y-3">
        ...
        <p className="text-xs text-slate-500">🔒 Secure AES-GCM Encrypted &bull; <a className="text-cyan-300/80 hover:text-cyan-200 transition underline decoration-cyan-300/30" href="/privacypolicybanao.html">Privacy & Security Policy</a></p>
      </footer>
    </main>
  );
}
